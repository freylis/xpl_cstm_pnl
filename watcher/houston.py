...
f_handler = handlers.TimedRotatingFileHandler(
    'E:\\SteamLibrary\\steamapps\\common\\X-Plane 12\\frey_watcher.log',
...
class ArduinoToXplane(Race):
    ...
    command_path = 'E:\\SteamLibrary\\steamapps\\common\\X-Plane 12\\frey_cmd_a.log'
    log_regexp = re.compile(r'\[frey-log-a] (\w+)', flags=re.I)
    log_path = 'E:\\SteamLibrary\\steamapps\\common\\X-Plane 12\\frey.log'
...
class XplaneToArduino(Race):
    ...
    command_path = 'E:\\SteamLibrary\\steamapps\\common\\X-Plane 12\\frey_cmd_x.log'
